...
Google Guava NuGet Package Xamarin.Google.Guava.ListenableFuture 

.NET for Android (formerly Xamarin.Android) Google Guava bindings NuGet Package 
Xamarin.Google.Guava.ListenableFuture  for Maven artifact:

artifact=com.google.guava:listenablefuture 

artifact_versioned=com.google.guava:listenablefuture:1.0.0

nuget=listenablefuture.1.0.0.18
