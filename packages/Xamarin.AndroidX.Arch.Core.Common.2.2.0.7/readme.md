...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Arch.Core.Common 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Arch.Core.Common 
for Maven artifact:

artifact=androidx.arch.core:core-common 

artifact_versioned=androidx.arch.core:core-common:2.2.0

nuget=core-common.2.2.0.7
