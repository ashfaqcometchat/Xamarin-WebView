...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Arch.Core.Runtime 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Arch.Core.Runtime 
for Maven artifact:

artifact=androidx.arch.core:core-runtime 

artifact_versioned=androidx.arch.core:core-runtime:2.2.0

nuget=core-runtime.2.2.0.7
