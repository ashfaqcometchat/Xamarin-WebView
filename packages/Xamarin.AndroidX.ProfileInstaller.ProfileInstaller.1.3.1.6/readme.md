...
AndroidX Bindings NuGet Package Xamarin.AndroidX.ProfileInstaller.ProfileInstaller 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.ProfileInstaller.ProfileInstaller 
for Maven artifact:

artifact=androidx.profileinstaller:profileinstaller 

artifact_versioned=androidx.profileinstaller:profileinstaller:1.3.1

nuget=profileinstaller.1.3.1.6
