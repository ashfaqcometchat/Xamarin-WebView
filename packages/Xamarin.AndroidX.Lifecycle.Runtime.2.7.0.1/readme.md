...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Lifecycle.Runtime 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Lifecycle.Runtime 
for Maven artifact:

artifact=androidx.lifecycle:lifecycle-runtime 

artifact_versioned=androidx.lifecycle:lifecycle-runtime:2.7.0

nuget=lifecycle-runtime.2.7.0.1
