...
AndroidX Bindings NuGet Package Xamarin.AndroidX.VersionedParcelable 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.VersionedParcelable 
for Maven artifact:

artifact=androidx.versionedparcelable:versionedparcelable 

artifact_versioned=androidx.versionedparcelable:versionedparcelable:1.2.0

nuget=versionedparcelable.1.2.0.1
