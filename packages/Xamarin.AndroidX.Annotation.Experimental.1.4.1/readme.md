...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Annotation.Experimental 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Annotation.Experimental 
for Maven artifact:

artifact=androidx.annotation:annotation-experimental 

artifact_versioned=androidx.annotation:annotation-experimental:1.4.1

nuget=annotation-experimental.1.4.1
