...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Collection.Jvm 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Collection.Jvm 
for Maven artifact:

artifact=androidx.collection:collection-jvm 

artifact_versioned=androidx.collection:collection-jvm:1.4.0

nuget=collection-jvm.1.4.0.1
