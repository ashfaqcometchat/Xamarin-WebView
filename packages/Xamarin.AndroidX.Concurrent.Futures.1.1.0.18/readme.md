...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Concurrent.Futures 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Concurrent.Futures 
for Maven artifact:

artifact=androidx.concurrent:concurrent-futures 

artifact_versioned=androidx.concurrent:concurrent-futures:1.1.0

nuget=concurrent-futures.1.1.0.18
