...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Startup.StartupRuntime 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Startup.StartupRuntime 
for Maven artifact:

artifact=androidx.startup:startup-runtime 

artifact_versioned=androidx.startup:startup-runtime:1.1.1

nuget=startup-runtime.1.1.1.11
