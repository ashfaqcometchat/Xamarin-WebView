...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Lifecycle.Common 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Lifecycle.Common 
for Maven artifact:

artifact=androidx.lifecycle:lifecycle-common 

artifact_versioned=androidx.lifecycle:lifecycle-common:2.7.0

nuget=lifecycle-common.2.7.0.1
