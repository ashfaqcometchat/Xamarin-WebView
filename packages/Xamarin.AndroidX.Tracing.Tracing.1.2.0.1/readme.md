...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Tracing.Tracing 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Tracing.Tracing 
for Maven artifact:

artifact=androidx.tracing:tracing 

artifact_versioned=androidx.tracing:tracing:1.2.0

nuget=tracing.1.2.0.1
