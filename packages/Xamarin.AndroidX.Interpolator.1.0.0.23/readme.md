...
AndroidX Bindings NuGet Package Xamarin.AndroidX.Interpolator 

.NET for Android (formerly Xamarin.Android) AndroidX bindings NuGet Package Xamarin.AndroidX.Interpolator 
for Maven artifact:

artifact=androidx.interpolator:interpolator 

artifact_versioned=androidx.interpolator:interpolator:1.0.0

nuget=interpolator.1.0.0.23
